...
class ImageComposition():
  ...
  def __init__(self):
    ...
    self.max_foregrounds = 50
    self.mask_colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (0, 255, 255), (255, 0, 255),
                        (192, 192, 192), (128, 128, 128), (30,144,255), (128, 128, 0), (173,216,230), (128, 0, 128),
                        ...
                        (238,232,170), (189,183,107), (240,230,140), (128,128,3), (154,205,50), (85,107,47), (107,142,35),
  ...
  def _generate_images(self):
    ...
    for i in tqdm(range(self.count)):
      ...
      num_foregrounds = self.max_foregrounds
      foregrounds = []
  ...
  def _compose_images(self, foregrounds, background_path):
    ...
    for fg in foregrounds:
      ...
      # ==============================================================================================
      if fg['category'] == 'Kale':
        paste_position = (random.randint(0, min(370, max_x_position)), random.randint(0, max_y_position))
      elif fg['category'] == 'Lettuce':
        paste_position = (random.randint(min(370, max_x_position), min(640, max_x_position)), random.randint(0, max_y_position))
      elif fg['category'] == 'Spinach':
        # print('here1')
        paste_position = (random.randint(min(370*2, max_x_position), min(370*3, max_x_position)), random.randint(0, max_y_position))
      elif fg['category'] == 'Brussels_sprouts':
        paste_position = (random.randint(min(370*3, max_x_position), min(370*4, max_x_position)), random.randint(0, max_y_position))
      elif fg['category'] == 'Radish':
        paste_position = (random.randint(min(370*4, max_x_position), min(370*5, max_x_position)), random.randint(0, max_y_position))
      # ==============================================================================================
